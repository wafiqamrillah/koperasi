<x-splade-modal :close-button="true" :title="__('Show').' '. __('member')">
    <x-splade-form dusk="show-member">
            ...
            <x-splade-form dusk="show-member" :default="$member">
                <x-splade-data default="{ tab : 1 }">
                    ...
                    <div class="tab-content p-2">
                        ...
                        <div class="tab-pane" :class="{ 'active' : data.tab === 2 }" id="edit-member-others" dusk="show-user-others">
                            <div class="row">
                                <div class="col-6">
                                ...
                                <div class="col-12">
                                    <x-splade-input id="employee" name="employee.name_related" type="text" :label="__('HRD Employee Data')" :placeholder="__('HRD Employee Data')" readonly />
                                </div>
                            </div>
                        </div>
                    </div>
